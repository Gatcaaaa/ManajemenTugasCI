        ...
        <div class="row row-cards">
            <div class="col-12">
                <div class="card card-sm">
                    ...
                    <div class="card-body">
                        <h3 class="card-title">
                            Write a release note for Admin v1.0
                        </h3>
                        ...
                        <div class="text-secondary">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem facilis cum
                            numquam, qui magni odio explicabo eveniet libero laboriosam consequuntur.
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <a href="#" class="link-muted">
                                            <span class="badge bg-red text-red-fg">Hapus</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
